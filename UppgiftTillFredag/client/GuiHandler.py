...
class GuiHandler:
    ...
    def getIpAndPort(self):
        # GUI to get port and ip to connect to
        ...
        def confirmPortAndIpd():
            # Gets the entered port and ip and destroys the root
            ip = entOfIp.get()
            port = entOfPort.get()
    ...
    def funcToLogin(self):
        ...
        def confirmLogin():
            # Sends login and username and password
    ...
    def showMessage(self,text):
        # Checks if login/register is True of False
